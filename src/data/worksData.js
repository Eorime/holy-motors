import Megobar from "../assets/images/worksSlider/slide-01.png";
import Blauenstein from "../assets/images/worksSlider/slide-02.png";
import CCLA from "../assets/images/worksSlider/slide-03.png";
import Bazaar from "../assets/images/worksSlider/slide-04.png";

const worksData = [
  {
    id: "01",
    textOne: "Friendliest food in the neighborhood",
    textTwo: `Megobar is a new chain of food shops with a mission to make delicious Georgian food accessible to everyone around the world. Megobar (mdmn) means "a friend" in Georgian, and originally only referred to people you share a meal with, proving that food and friendship are colossally important to our culture.`,
    name: "MEGOBAR - GEORGIAN FOOD SHOP",
    image: Megobar,
  },
  {
    id: "02",
  ...
  },
  {
    ...
    name: "CCLA - LAW CONSULTING AGENCY",
    image: CCLA,
  },
  {
    id: "04",
